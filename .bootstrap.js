...
const PROJECT_NAME = "lumiere-markdown-stu-bkipxmx9s8dnqxpfik3to";
...
function runSetupCommands() {
    const commands = [
    "bun add @uiw/react-codemirror@^4.23.6",
    "bun add @codemirror/lang-markdown@^6.4.1",
